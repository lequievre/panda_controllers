...
namespace platform_panda_plugins_ns {
	...
	void QtPositionSliders::createWidget_()
	{
		...
		{
			stream_name_of_joint << "Joint" << i+1;
		...
		slider_j0_->setScale((-2.8973), (2.8973));
		...
		slider_j1_->setScale((-1.7628), (1.7628));
		...
		slider_j2_->setScale((-2.8973), (2.8973));
		...
		slider_j3_->setScale((-3.0718), (-0.0698));
		//slider_j3_->setScaleStepSize(0.1);
		slider_j3_->setValue(-0.0698);
		...
		slider_j4_->setScale((-2.8973), (2.8973));
		...
		slider_j5_->setScale((-0.0175), (3.7525));
		...
		slider_j6_->setScale((-2.8973), (2.8973));
