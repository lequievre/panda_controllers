		...
		public:
		 ...
		 public slots:
		  ...
		  private:
			...
			QWidget* widget_positions_, * widget_global_;
			...
			void jsCallback_panda_1_(const sensor_msgs::JointState::ConstPtr& msg);
			//void jsCallback_panda_2_(const sensor_msgs::JointState::ConstPtr& msg);
			
			platform_panda_plugins_ns::QtPlotChecked *plot_checked_;
			platform_panda_plugins_ns::QtPositionSliders *position_sliders_;
